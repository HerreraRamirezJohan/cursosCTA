...
@section('content')
    <div class="container text-center">
                                    ...
                                    @auth
                                        <td colspan="4">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <a href="{{ route('editar', $curso->curso->id) }}" class="text-reset">
                                                ...
                                                <a id="eliminar" href="{{ route('eliminar', $curso->curso->id) }}"
        ...
        <script>
            let enlace = document.querySelector("#eliminar");
            // console.log(enlace);
            enlace.addEventListener('click', function(e) {
                e.preventDefault();
                let respuesta = confirm('¿Deseas eliminar el curso?');
                if (respuesta) {
